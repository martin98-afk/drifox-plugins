...
> 🦊 **DriFox Plugin** — install via Plugin Marketplace. `skills.web-design-skills`
...
### DriFox Plugin (recommended)

Install via Plugin Marketplace:

```
Plugin: web-design-skills
├── .drifox-plugin/plugin.json     Plugin manifest
├── skills/web-design-engineer/    Skill root
│   ├── SKILL.md                   Main skill file
│   └── references/
│       ├── advanced-patterns.md   Code template library
│       ├── block-library.md       Index of reusable blocks
│       ├── browser-acceptance.md  Browser QA harness (explicit request only)
│       ├── design-calibration.md  Design Read + five dials
│       ├── design-directions.md   Design Direction Advisor
│       ├── failure-patterns.md    AI-design failure taxonomy
│       ├── redesign-protocol.md   Extension / Preserve / Overhaul
│       ├── style-recipes/         25 anchored style recipes
│       │   ├── INDEX.md           Catalog index + 3 cross-indexes
│       │   └── *.md               Single-recipe files
│       └── critique-guide.md      5-dimension scoring rubric
├── README.md / README.zh-CN.md
└── __init__.py                    Python package marker
```

### For Claude Code / Cursor (standalone)
...
│   ├── SKILL.md                          # Main skill file
│   └── references/                       # Same structure as above
└── ...
```
