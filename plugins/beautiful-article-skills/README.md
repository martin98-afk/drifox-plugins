...
[中文文档](./README.zh-CN.md) · [DriFox Plugin](../../README.md#plugins)

> 🦊 **DriFox Plugin** — install via Plugin Marketplace. `skills.beautiful-article-skills`
...
## Skill structure (DriFox Plugin)

```text
beautiful-article-skills/                ← DriFox plugin root
├── .drifox-plugin/plugin.json           Plugin manifest (name: beautiful-article-skills)
├── skills/beautiful-article/           ← Skill root
...
│   │   ├── plan-template.md             Single plan.md template
│   │   ├── theme-selection.md           Theme picker
│   │   ├── layout.md                    Width modes, TOC defaults
│   │   ├── cover.md                     3:4 book-style cover guide
│   │   ├── asset-policy.md              Image strategy
│   │   ├── component-policy.md          Reacticle component contract
│   │   ├── raw-policy.md                Raw allow / deny list
│   │   ├── section-build.md             One-section-one-file rule
│   │   ├── source-to-markdown.md        Per-format extraction rules
│   │   ├── scaffold.md                  Scaffold script behaviour
│   │   ├── html-output.md               dev / build / single-file commands
│   │   ├── pdf-output.md                html-to-pdf.sh usage
│   │   ├── review-checklist.md          Per-phase reviewer checklists
│   │   ├── repair-policy.md             Minimal-slice repair table
│   │   └── harness.md                   Skill-as-harness perspective
│   ├── theme-profiles/
│   │   ├── index.json                   Theme registry
│   │   └── *.md                         11 theme profiles
│   ├── scripts/
│   │   ├── scaffold.sh                  Workspace bootstrap
│   │   ├── html-to-pdf.sh               Optional HTML → PDF
│   │   ├── pdf-print-overrides.css      @media print overrides
│   │   ├── source-to-markdown-markitdown.py  Main extraction path
│   │   └── source-to-markdown.py        Lightweight fallback
│   └── assets/
│       └── scaffold-template/           Vite + React + TS scaffold template
