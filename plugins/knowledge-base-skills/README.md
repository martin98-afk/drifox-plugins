...
> 🦊 **DriFox Plugin** — install via Plugin Marketplace. `skills.knowledge-base-skills`
...
```
knowledge-base-skills/                  ← DriFox plugin root
├── .drifox-plugin/plugin.json          Plugin manifest (name: knowledge-base-skills)
├── skills/kb-retriever/               ← Skill root (name: kb-retriever)
│   ├── SKILL.md                         Main skill
│   ├── references/
